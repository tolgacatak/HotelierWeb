...
namespace Hotel.WebApi.Controllers
{
    ...
    public class DashBoardWidgetsController : ControllerBase
    {
        ...
        public DashBoardWidgetsController(ICrewService crewService, IBookingService bookingService, IAppUserService appUserService, IRoomService roomService)
        {
        ...
        [HttpGet("CrewCount")]
        public IActionResult CrewCount()
        {
            var value = _crewService.TGetCrewCount();
            return Ok(value);
        }
